...
> 仙台の人気ラーメン店「カスラーメン自家製麺キリンジ」が自社開発したモバイルオーダーシステムです。  
...
券売機の代わりにスマホで注文できる仕組みを、プログラミング未経験のラーメン店オーナーがAI（Claude）と一緒に作りました。
...
> このアプリはAI（[Claude](https://claude.ai)）と会話しながら開発しました。  
